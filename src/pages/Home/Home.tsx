...
const Home: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <SkipPreviousIcon
                            sx={{
                                color: currentSongIndex === 0 ? "rgba(0, 0, 0, 0.5)" : "#000000",
                                paddingRight: "1rem",
                            }}
                        />
                    </IconButton>
            ...
            >
                <Link
                    href="https://www.buymeacoffee.com/melodicmango"
                    target="_blank"
            ...
            >
                ...
                >
                    ...
                    >
                        {currentSongIndex + 1} / {playlist.length} songs
                    </Typography>
                </Box>
            </Box>
